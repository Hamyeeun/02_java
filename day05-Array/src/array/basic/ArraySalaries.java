...
public class ArraySalaries {
	...
	public static void main(String[] args) {
		...
		// 2. 초기화 : 배열참조 변수는 기본형이 아니므로
		// 초기화를 위해 new 를 사용해야한다.
		// 배열 괄호 안에 배열의 크기를 입력한다.
		salaries = new int[10];
		// 3. 사용
		// (1) 배열의 값을 넣기 전에 출력
		// 일반 기본형 변수는 명시적 초기화 후에 사용 가능
//		int age;
//		System.out.println("나이 : " + age);
		System.out.println("=== 배열 생성 직후 원소 출력 ===");
		...
		System.out.println("=== 배열 값 할당 후 원소 출력 ===");
		System.out.printf("salaries[0] : %d%n", salaries[0]);
		System.out.printf("salaries[1] : %d%n", salaries[1]);
		System.out.printf("salaries[2] : %d%n", salaries[2]);
		System.out.printf("salaries[3] : %d%n", salaries[3]);
		...
		System.out.println("=== 배열 값 할당 후 원소 출력(for loop) ===");
		// for 문을 사용하여 배열 원소 출력
